...
/**
 * Table - класс для работы с данными, которые можно представить в виде таблицы
 *
...
class Table
{
     ...
     * @return array
     */
    public function toArray(Node $field = null, $bMulti = false)
    {
    ...
    public function toAssoc(Node $field = null, $bMulti = false)
    {
        $aReturn = array();
    ...
    /**
     * @param Node $field - UNIQUE KEY CELL
     * @param array $aMulti
     * @param int $type
     * @param bool $int
     * @return array
